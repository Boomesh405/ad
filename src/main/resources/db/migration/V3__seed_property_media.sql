-- Seed property_media with real building images from Unsplash (free, no attribution)
-- Each property gets 3 photos: 1 cover + 2 gallery

INSERT INTO property_media (media_id, property_id, media_type, s3_key, alt_text, display_order, is_cover_photo) VALUES
